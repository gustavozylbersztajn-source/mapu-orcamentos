...
CABIN_MAP = {
    ...
    "CHAITEN": {
        ...
        (2, 0): ("J", "BUDGET CHAITEN 2"),
        (3, 0): ("K", "BUDGET CHAITEN 3"),
        (2, 1): ("L", "BUDGET CHAITEN 2+1"),
        (2, 2): ("M", "BUDGET CHAITEN 2+2"),
    },
    "CORCOVADO": {
        (1, 0): ("N", "BUDGET CORCOVADO 1"),
        (2, 0): ("O", "BUDGET CORCOVADO 2"),
        (2, 1): ("P", "BUDGET CORCOVADO 2+1"),
        (2, 2): ("Q", "BUDGET CORCOVADO 2+2"),
        (2, 3): ("R", "BUDGET CORCOVADO 2+3"),
        (3, 0): ("S", "BUDGET CORCOVADO 3"),
        (3, 1): ("T", "BUDGET CORCOVADO 3+1"),
        (3, 2): ("U", "BUDGET CORCOVADO 3+2"),
        (4, 0): ("V", "BUDGET CORCOVADO 4"),
        (4, 1): ("W", "BUDGET CORCOVADO 4+1"),
        (5, 0): ("X", "BUDGET CORCOVADO 5"),
    },
}
