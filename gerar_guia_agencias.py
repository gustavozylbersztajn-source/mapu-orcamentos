...
CONTENT = {
    "PT": {
        ...
        "steps": [
            ...
            ("Refeições",          "Cafe da manha opcional, por pessoa, disponivel o ano todo."),
    ...
    "EN": {
        ...
        "steps": [
            ...
            ("Meals",                 "Breakfast optional, per person, available year-round."),
    ...
    "ES": {
        ...
        "steps": [
            ...
            ("Comidas",                "Desayuno opcional, por persona, disponible todo el ano."),
